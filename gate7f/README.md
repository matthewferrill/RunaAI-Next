...
The complete R10 three-model functional comparison is recorded in
`function-first/M1-S2-R10-THREE-MODEL-RESULTS-2026-08-30.md`. Gemma and Coder
qualify only for Chat and Code; Research, Agent and Review remain unqualified and
no whole candidate qualifies. The prospective R11 correction is frozen in
`function-first/M1-S2-R11-CORRECTIVE-CRITERIA-2026-08-30.md`. These results do
not select or deploy a production route, close M1 or replace the remaining
roadmap.
