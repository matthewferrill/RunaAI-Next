...
const RuntimeSealV8Schema = z.object({ schemaVersion: z.literal("runaai-m1-functional-runtime-seal/v8"), ...runtimeSealFields(CASE_BUNDLE_SHA256),
  qualificationCriteria: z.object({ schemaVersion: z.literal("runaai-m1-r12-qualification-criteria/v1"),
    path: z.literal("gate7f/function-first/M1-S2-R12-COMBINED-BROWSER-PUBLICATION-CRITERIA-2026-08-31.md"),
    sha256: hex, normalizedSha256: hex, rubricVersion: z.literal("2026-08-31.r12-combined-browser-publication") }).strict(),
}).strict();
const RuntimeSealV9Schema = z.object({ schemaVersion: z.literal("runaai-m1-functional-runtime-seal/v9"), ...runtimeSealFields(CASE_BUNDLE_SHA256),
  qualificationCriteria: z.object({ schemaVersion: z.literal("runaai-m1-r13-qualification-criteria/v1"),
    path: z.literal("gate7f/function-first/M1-S2-R13-AGENT-REVIEW-CORRECTIVE-CRITERIA-2026-08-31.md"),
    sha256: hex, normalizedSha256: hex, rubricVersion: z.literal("2026-08-31.r13-agent-review-correction") }).strict(),
}).strict();
const RuntimeSealV10Schema = z.object({ schemaVersion: z.literal("runaai-m1-functional-runtime-seal/v10"), ...runtimeSealFields(CASE_BUNDLE_SHA256),
  qualificationCriteria: z.object({ schemaVersion: z.literal("runaai-m1-r14-qualification-criteria/v1"),
