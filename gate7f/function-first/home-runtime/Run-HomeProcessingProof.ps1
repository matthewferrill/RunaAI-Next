...
if($root-cne$config.homeRoot-or$config.proofId-cne'20260829-native-processing-nomic-r1'-or$config.policy.proofDeadlineMs-ne900000){throw 'processing-proof-supervisor-config'}
