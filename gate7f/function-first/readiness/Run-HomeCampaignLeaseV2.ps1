...
if($root-cne$config.homeRoot-or$config.leaseId-notmatch'^20260829-campaign-(gemma|coder|qwen36)-r[1-9][0-9]*$'-or$config.schemaVersion-cne'runa-m1-campaign-lease/v2'-or$config.profile-notin@('campaign-v2','campaign-v2-extended')){throw 'lease-v2-supervisor-root'}
$p=$config.policy
$legacy=$config.profile-ceq'campaign-v2'-and$p.readyLeaseMs-eq4200000-and$p.maximumBatchMs-eq3600000-and$p.minimumLaunchRemainingMs-eq3780000-and$p.workerDeadlineMs-eq4920000-and$p.supervisorDeadlineMs-eq5160000-and$p.taskDeadlineMs-eq5160000
$extended=$config.profile-ceq'campaign-v2-extended'-and$p.readyLeaseMs-eq5100000-and$p.maximumBatchMs-eq4500000-and$p.minimumLaunchRemainingMs-eq4680000-and$p.workerDeadlineMs-eq5820000-and$p.supervisorDeadlineMs-eq6060000-and$p.taskDeadlineMs-eq6060000
if((-not$legacy-and-not$extended)-or$p.preparationMs-ne600000-or$p.dispatchStopMarginMs-ne240000-or$p.publicationMarginMs-ne180000-or$p.runnerFinalizationMs-ne60000-or$p.completionPublicationMs-ne120000-or$p.ownedCleanupMs-ne120000-or$p.independentRecoveryMs-ne240000-or$p.preparationMs+$p.readyLeaseMs+$p.ownedCleanupMs-ne$p.workerDeadlineMs-or$p.maximumBatchMs+$p.publicationMarginMs-ne$p.minimumLaunchRemainingMs-or$p.runnerFinalizationMs+$p.completionPublicationMs-ne$p.publicationMarginMs-or$p.workerDeadlineMs+$p.independentRecoveryMs-ne$p.supervisorDeadlineMs-or$p.supervisorDeadlineMs-ne$p.taskDeadlineMs){throw 'lease-v2-supervisor-policy'}
