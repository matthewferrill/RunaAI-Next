...
assert(['prospective-r6-hardware-only-not-functional-qualification','prospective-r7-hardware-only-not-functional-qualification',
  'prospective-r8-hardware-only-not-functional-qualification','prospective-r9-hardware-only-not-functional-qualification'].includes(classification),'v2-campaign-classification');
const policy=classification==='prospective-r9-hardware-only-not-functional-qualification'
