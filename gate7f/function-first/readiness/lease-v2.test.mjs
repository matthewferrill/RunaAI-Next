...
import {CAMPAIGN_V2_POLICY,policyForV2Lease,validateCampaignV2Policy,validV2Completion,validV2BatchResult,campaignV2Windows} from './lease-v2-contract.mjs';
...
test('PowerShell supervisor and dispatcher pin finite82/86 ceilings and only the v2 worker',async()=>{
  ...
  assert.match(supervisor,/workerDeadlineMs-ne4920000/u);assert.match(supervisor,/supervisorDeadlineMs-ne5160000/u);
